    ...
    const fetchPerfil = async () => {
      try {
        ...
        const response = await fetch(
          `http://localhost:8081/api/profesores/${id}`,
        ...
        <div style={{ background: cardBg, border: cardBorder, borderRadius: "12px", padding: "24px" }}>
          ...
          {seccion === "grupos" && (
            <div>
              ...
              <p style={{ color: textoS, fontSize: "14px" }}>
                Módulo de grupos — disponible cuando implementemos las tablas de grupos.
              </p>
            </div>
          )}
          ...
          {seccion === "estudiantes" && (
            <div>
              <h2 style={{ margin: "0 0 20px", fontSize: "18px", fontWeight: "500", color: textoP }}>Estudiantes por grupo</h2>
              <p style={{ color: textoS, fontSize: "14px" }}>
                Módulo de estudiantes — disponible cuando implementemos las tablas de grupos y matrículas.
              </p>
            </div>
          )}
